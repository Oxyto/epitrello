<div id="user-search-bar" class="flex h-16 items-center gap-4 bg-gray-800 p-4 shadow-md">
	...
	<a href="#create" class="rounded bg-blue-500 px-4 py-2 text-white hover:bg-blue-600">Create</a>
	...
	>
	<a href="#profile" class="rounded bg-blue-600 px-4 py-2 text-white hover:bg-blue-700"
		><img src="/path/to/profile/icon.svg" alt="Profile" /></a
	>
</div>
